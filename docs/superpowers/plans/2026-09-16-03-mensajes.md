...
Si otra pista mergeó una migración con timestamp **posterior** al de `mensajes`, no hace falta renombrar nada. Si mergeó una con timestamp **anterior** que todavía no está en esta rama, el rebase la trae y el orden queda correcto.
